...
public class AMConfiguredStructures {
    /**
     * Static instance of our structure so we can reference it and add it to biomes easily.
     */
    public static ConfiguredStructureFeature<?, ?> CONFIGURED_ATIUM_GEODE_STRUCTURE = AMStructures.ATIUM_GEODE_STRUCTURE.get()
    ...
    public static void registerConfiguredStructures() {
        ...
        Registry.register(registry, new ResourceLocation(AtiumMod.MOD_ID, "atium_geode_structure"), CONFIGURED_ATIUM_GEODE_STRUCTURE);
    }
}
