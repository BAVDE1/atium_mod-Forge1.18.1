...
public class InfusingTableRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public InfusingTableRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Type implements RecipeType<InfusingTableRecipe> {
        private Type() { }
    ...
    public static class Serializer implements RecipeSerializer<InfusingTableRecipe> {
        ...
        public InfusingTableRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new InfusingTableRecipe(id, output, inputs);
        }

        @Override
        public InfusingTableRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf buf, InfusingTableRecipe recipe) {
