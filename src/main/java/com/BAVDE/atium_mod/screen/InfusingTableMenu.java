...
public class InfusingTableMenu extends AbstractContainerMenu {
    ...
    public InfusingTableMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()));
    }

    public InfusingTableMenu(int pContainerId, Inventory inv, BlockEntity entity) {
        super(ModMenuTypes.INFUSING_TABLE_MENU.get(), pContainerId);
