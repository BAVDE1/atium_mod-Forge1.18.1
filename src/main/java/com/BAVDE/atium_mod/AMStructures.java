...
/**  * Registers the base structure itself and sets what its path is. In this case,
     * this base structure will have the resourcelocation of atium_mod:atium_geode_structures.*/

    public static final RegistryObject<StructureFeature<?>> ATIUM_GEODE_STRUCTURES = DEFERRED_REGISTRY_STRUCTURE.register("atium_geode_structure", AtiumGeodeStructure::new);
}
